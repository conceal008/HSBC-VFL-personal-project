...
**[`modules/m9_documentation/对外表述红线.md`](modules/m9_documentation/对外表述红线.md)** —— 🔴 **对外材料发布前必读**：9 条绝对不能说的话。
**[`modules/m8_industrialization/上线准入清单.md`](modules/m8_industrialization/上线准入清单.md)** —— 上线前逐条勾选；当前 5 项阻塞全部未解除。
